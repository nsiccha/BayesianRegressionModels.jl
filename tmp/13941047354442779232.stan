...
transformed data {
    int b_p_subject_n_g = max(subject_idx);
...
parameters {
    ...
    vector[(n_terms_p_subject * b_p_subject_n_g)] b_p_subject_z_flat;
...
transformed parameters {
    matrix[n_terms_p_subject, b_p_subject_n_g] b_p_subject_z = reshape(b_p_subject_z_flat, n_terms_p_subject, b_p_subject_n_g);
    matrix[b_p_subject_n_g, n_terms_p_subject] b_p_subject = ((diag_pre_multiply(b_p_subject_tau, b_p_subject_L) * b_p_subject_z)');
