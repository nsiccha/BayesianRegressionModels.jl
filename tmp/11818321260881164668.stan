...
parameters {
    ...
    array[n_subject] vector[n_terms_p_subject] b_p_subject_b;
...
transformed parameters {
    matrix[n_subject, n_terms_p_subject] b_p_subject = ranef_b_matrix(b_p_subject_b);
...
model {
    ...
    b_p_subject_b ~ multi_normal_cholesky0(diag_pre_multiply(b_p_subject_tau, b_p_subject_L));
